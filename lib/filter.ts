 ...
 * entity, not excluded slang, and its POS chip is on — with the prototype's
 * fall-through: PROPN passes when entities aren't excluded, INTJ passes
 * when slang isn't excluded, regardless of the NOUN/VERB/ADJ chips.
 */
